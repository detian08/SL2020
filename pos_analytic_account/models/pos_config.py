...
class PosOrder(models.Model):
    ...
    def _prepare_analytic_account(self, line):
        analytic_account_id = line.order_id.session_id.config_id.analytic_account_id
        return analytic_account_id and analytic_account_id.id or False
    ...
    def _create_account_move_line(self, session=None, move=None):
        ...
        for order in self.filtered(lambda o: not o.account_move or o.state == 'paid'):
            ...
            data = {
                ...
                'partner_id': partner_id,
                'analytic_account_id': order.session_id.config_id.analytic_account_id.id,
            }
            if cur != cur_company:
                data['currency_id'] = cur.id
    ...
    def _reconcile_payments(self):
        for order in self:
            ...
            move = order.statement_ids.mapped('journal_entry_ids') | order.account_move.line_ids | order.invoice_id.move_id.line_ids
            ...
            try:
                ...
                for entry in move:
                    entry.analytic_account_id = order.session_id.config_id.analytic_account_id.id
