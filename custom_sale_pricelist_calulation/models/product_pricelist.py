...
class ProductTemplate(models.Model):
    ...
    second_sale_price = fields.Float(string='Second Sale Price', digits=dp.get_precision('Product Price'),
                                     default=0.0)
...
class PricelistItem(models.Model):
    ...
    second_sale_price = fields.Boolean(string='Apply on Second Sale Price')
        ...
        def _compute_price_rule(self, products_qty_partner, date=False, uom_id=False):
            ...
            for product, qty, partner in products_qty_partner:
                ...
                for rule in items:
                    ...
                    print("rule.base_pricelist_id>>>>>>>>>", rule.base_pricelist_id)
                    if rule.base == 'pricelist' and rule.base_pricelist_id:
                        ...
                        if product.second_sale_price > 0 and rule.second_sale_price:
                            price = product.second_sale_price
